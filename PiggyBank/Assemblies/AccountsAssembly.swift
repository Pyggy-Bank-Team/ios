...
final class AccountsAssembly: Assembly {
    ...
    func assemble(container: Container) {
        ...
        container.autoregister(DeleteAndUpdateAccountsUseCase.self, initializer: DeleteAndUpdateAccountsUseCase.init)
        container.autoregister(CreateUpdateAccountUseCase.self, initializer: CreateUpdateAccountUseCase.init)
        container.autoregister(ChangeAndUpdateAccountsUseCase.self, initializer: ChangeAndUpdateAccountsUseCase.init)
