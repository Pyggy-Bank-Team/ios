...
open class DatePickerDialog: UIView {
    ...
    public init(
        ...
        self.textColor = textColor ?? UIColor.text
        self.buttonColor = buttonColor ?? UIColor.accent
        self.font = font
    ...
    open func show(
        ...
        guard let appDelegate = UIApplication.shared.delegate else {
            fatalError("App delegate is not defined")
        }
        guard let window = appDelegate.window else {
            fatalError("Window is not defined")
        }
    ...
    private func createContainerView() -> UIView {
        ...
        gradient.colors = UIColor.gradientBackground
    ...
    private func configuredDatePicker() -> UIDatePicker {
